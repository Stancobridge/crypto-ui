  ...
  (k.fn.exists = function () {
    ...
    (w.Util.classInit = function () {
      function a() {
        !0 === w.getStatus.asMobile
          ? r.addClass("as-mobile")
          : r.removeClass("as-mobile");
      }
      !0 === w.getStatus.isTouch
        ? r.addClass("has-touch")
        : r.addClass("no-touch"),
        a(),
        "rtl" === r.attr("dir") &&
          (r.addClass("has-rtl"), (w.getStatus.isRTL = !0)),
        r.addClass("nk-" + l),
        k(o).on("resize", a);
    }),
    ...
    (w.Util.preLoader = function () {
      var a = k(".preloader"),
        l = k(".spinner");
      a.exists() &&
        (r.addClass("page-loaded"),
        l.addClass("load-done"),
        l.hasClass("spinner-alt") || l.fadeOut(300),
    ...
    (w.Util.browser = function () {
      var a = -1 !== navigator.userAgent.indexOf("Chrome") ? 1 : 0,
        ...
        s =
          -1 !== navigator.userAgent.indexOf("MSIE") || d.documentMode ? 1 : 0,
        i = !s && !!o.StyleMedia,
        t =
          ...
          hasFixed: function () {
            if (l.exists()) {
              ...
              P.on("scroll", function () {
                P.scrollTop() > a.top
                  ? l.hasClass(e) || l.addClass(e)
                  : l.hasClass(e) && l.removeClass(e);
              });
            }
          },
          hasShrink: function () {
    ...
    (w.Util.Ovm = function () {
      ...
      a.exists() &&
        a.each(function () {
          k(this).parent().hasClass("has-ovm") ||
            k(this).parent().addClass("has-ovm");
        }),
        l.exists() &&
          l.each(function () {
            k(this).parent().hasClass("has-mask") ||
              k(this).parent().addClass("has-mask");
          }),
        e.exists() &&
          e.each(function () {
            k(this).parent().hasClass("has-ovm") ||
    ...
    (w.Util.progressBar = function () {
      ...
      a.exists() &&
        ...
        l.exists() &&
          !0 === w.getStatus.isRTL &&
          l.each(function () {
            k(this).css("right", k(this).data("point") + "%"),
              k(this).css("left", "auto");
          });
    }),
      ...
      a.exists() &&
        a.each(function () {
          ...
          l && a.parent().addClass(e),
            ...
            a.on("blur", function () {
              k(this).parent().removeClass(e),
                k(this).val() && k(this).parent().addClass(e);
            });
        });
    }),
    ...
    (w.Util.toggler = function () {
      ...
      k(s).exists() &&
        m.on("click", s, function (a) {
          var l = k(this);
          k(s).not(l).removeClass("active"),
            k(i).not(l.parent().children()).removeClass("active"),
            l.toggleClass("active").parent().find(i).toggleClass("active"),
            a.preventDefault();
        }),
        m.on("click", "body", function (a) {
          ...
          e.is(a.target) ||
            ...
            l.is(a.target) ||
            0 !== l.has(a.target).length ||
            (e.removeClass("active"), l.removeClass("active"));
        });
    }),
          ...
          a.waypoint(
            function () {
              a.addClass("animated " + l).css("visibility", "visible"),
                e && a.css("animation-duration", e + "s"),
        ...
        c = {
          ...
          navClose: function () {
            k(".header-navbar-overlay").on("click", function () {
              ...
              a.on("click", function () {
                k(this).hasClass("menu-toggle") ||
                  (l.removeClass(n),
                  e.removeClass(d),
                  r.removeClass("overlay-" + d));
              }),
              m.on("click", "body", function (a) {
                !i.is(a.target) &&
          ...
          menuToggle: function () {
            i.exists() &&
              i.on("click", function (a) {
                var l = k(this).parent();
                P.width() < 992 &&
                  (l.children(t).slideToggle(400),
                  l.siblings().children(t).slideUp(400),
                  l.toggleClass(o),
                  l.siblings().removeClass(o)),
                  a.preventDefault();
              });
          },
          mobileNav: function () {
            P.width() < 992
              ? e.delay(500).addClass(v)
              : (e.delay(500).removeClass(v), e.removeClass(d));
          },
              ...
              a.each(function () {
                g === this.href &&
                  ...
                  k(this)
                    ...
                    .closest("li")
                    .addClass("active"),
                  (void 0 !== g && void 0 !== u) || r.addClass("d-stan");
              });
          },
        };
      c.Overlay(),
        ...
        a.each(function () {
          var a = k(this),
            ...
            s = a.data("items-tab-l")
              ...
              ? l - 1
              : l,
            i = a.data("items-tab-p")
              ? a.data("items-tab-p")
              : 2 < s
              ? s - 1
              : s,
            t = a.data("items-mobile")
              ? a.data("items-mobile")
              : 1 < i
              ? i - 1
              : i,
          ...
          l <= 1 && (l = e = s = i = t = 1),
            a.addClass("owl-carousel").owlCarousel({
              ...
              responsive: {
                0: { items: o, margin: x },
                576: { items: o, margin: x },
                768: { items: i, margin: p },
                992: { items: e, margin: p },
                1200: { items: l, margin: u },
                1600: { items: e, margin: u },
              },
