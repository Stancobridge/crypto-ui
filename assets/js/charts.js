          ...
          var r = document.getElementById(a).getContext("2d"),
            i = new Chart(r, {
              ...
              options: {
                legend: {
                  display: !1,
                  labels: { boxWidth: 10, fontColor: "#000" },
                },
                rotation: -2,
                cutoutPercentage: s,
                responsive: !0,
                  ...
                  hover: {
                    onHover: function (a, t) {
                      if (t.length) {
                        ...
                        u('[data-canvas="' + n + '"] li').removeClass("active"),
                          u(
                            '[data-canvas="' + n + '"] li:nth-child(' + o + ")"
                          ).addClass("active");
                      } else
                        u('[data-canvas="' + n + '"] li').removeClass("active");
                    },
        ...
        0 < t.length &&
          t.each(function () {
            var a = u(this).children("li"),
              ...
              o = u(this).data("border-color")
                ? u(this).data("border-color")
                : "#fff",
              n = u(this).data("canvas-cutout")
                ? u(this).data("canvas-cutout")
                : "70",
              e = u(this).data("canvas-type");
            if (
              ((e = void 0 === e || "" === e ? "doughnut" : e),
              void 0 !== t && "" !== t)
            ) {
              var s = [],
                r = [],
              ...
              a.each(function () {
                ...
                "doughnut" === e
                  ? c.Chart.ChartJs.Doughnut(t, s, r, i, o, n)
                  : "pie" === e
                  ? c.Chart.ChartJs.Pie(t, s, r, i, o)
                  : "linechart" === e &&
                    c.Chart.ChartJs.Doughnut(t, s, r, i, o);
          ...
          o.each(function () {
            ...
            if (
              ...
              a.each(function () {
                ...
                "doughnut" === e
                  ? c.Chart.ChartJs.Doughnut(t, r, i, l, h, o, n)
                  : "pie" === e
                  ? c.Chart.ChartJs.Pie(t, r, i, l, d, h, o)
                  : "linechart" === e &&
                    c.Chart.ChartJs.Doughnut(t, r, i, l, h, o);
            } else console.log("Unable to draw canvas: " + t);
          }),
        0 < n.length &&
          n.each(function () {
            ...
            if (
              ...
              for (var d = 0; d < a.length + 1; d++)
                a.eq(d - 1).addClass("chart-index-" + d);
              "doughnut" === e
                ? c.Chart.ChartJs.Doughnut2(t, s, r, l, o, n)
                : "pie" === e
                ? c.Chart.ChartJs.Pie(t, s, r, i, l, o)
                : "linechart" === e && c.Chart.ChartJs.Doughnut(t, s, r, l, o);
            } else console.log("Unable to draw canvas: " + t);
          });
    }),
    c.components.docReady.push(c.Chart.ChartJs),
    c
  );
